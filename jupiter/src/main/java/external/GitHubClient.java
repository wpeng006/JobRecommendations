...
public class GitHubClient {
	...
	//search items with given input
	//return a list of items in the format of JSONArray
	public List<Item> search(double lat, double lon, String keyword) {
		if (keyword == null) {
			keyword = DEFAULT_KEYWORD;
		}
		//make the keyword usable in a url
		try {
		...
		// only do this when no response from the search request
		return new ArrayList<>();
	}
	
	//filter JSONArray array and output the useful data (Item)
